...
if($system['data']['menu']['skin_group'] != "" && $system['data']['menu']['skin'] != "")
{
    ...
    define("BASE_SKIN_PATH",  BASE_PATH."/".SITE_NAME."/skin/base/".$skin_group."/");
    define("BASE_SKIN_URL", "skin/base/".$skin_group."/");
    
    if(file_exists(SKIN_PATH."modecheck.php")) include SKIN_PATH."modecheck.php";
    ...
    if(file_exists(SKIN_PATH."/config.php")) include_once SKIN_PATH."/config.php";
    if(file_exists(SKIN_PATH."sql.php")) include SKIN_PATH."sql.php";
