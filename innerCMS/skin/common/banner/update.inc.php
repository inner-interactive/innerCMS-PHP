<form action="<?php echo SKIN_URL?>update.php" class="editor_form" method="post" enctype="multipart/form-data">
	...
	<div class="function mt20" style="text-align:center">
		...
		<input type="hidden" name="backUrl" value="<?php echo getBackUrl('menu|type|no', 1)."&mode=view"?>" />
		<a href="<?php echo getBackUrl('menu|type|no')?>&mode=view" class="btn btn-default">뒤로</a>
	</div>
</form>