...
<div class="function mt30">
	<a class="btn btn_apply" href="<?=getBackUrl("menu")?>&amp;mode=write">회원등록</a>
</div>
<?php if($isAdmin){?>
...
<?php }?>
	<table class="table_basic th-g">
		...
		<tr>
			...
			<td>
				<?php if($isAdmin){?><input type="checkbox" class="indexno" name="indexno[]" value="<?=$dbData[$i]['indexcode']?>" /><?php }?>
...
<div class="float-left mt10">
	<a class="btn btn_apply" href="<?=SKIN_URL?>exceldown.php">엑셀다운로드</a>
</div>
