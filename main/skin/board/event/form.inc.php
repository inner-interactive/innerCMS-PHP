...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			<strong class="title"><label for="f4">기간</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f1">장소</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f2">주최</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f3">주관</label></strong> <span
