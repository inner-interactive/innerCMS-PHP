...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			<strong class="title"><label for="f1">영상 URL</label></strong> <span
				class="input"> <input type="text" name="f1" id="f1" class="w100p"
				value="<?=$dbData[0]['f1']?>"
				placeholder="YouTube 공유 URL을 복사하여 붙여넣기 해 주세요. url 예시 : https://youtu.be/abcdefgh1234" />
			</span>
		</div>
