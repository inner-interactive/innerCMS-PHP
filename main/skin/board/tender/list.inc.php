		...
		<table>
			...
			<thead>
				<tr>
					...
					<th scope="col" class="mhide">모집기간</th>
					<th scope="col" class="mhide">상태</th>
    ...
    for ($i = 0; $i < count($dbData); $i ++) {
        ...
        ?>
				<tr>
					...
					<td scope="col" class="stout">
					<?=dateDisplay($dbData[$i]['f1'], $dbData[$i]['f2'])?>
					</td>
					<td scope="col" class="stout">
					<?=getStatusIcon($dbData[$i]['f1'], $dbData[$i]['f2'], $dbData[$i]['num1'])?>
					</td>
				...
				<tr>
					<td colspan="7">조건에 해당되는 글이 존재하지 않습니다.</td>
				</tr>
				<?php }?>
			</tbody>
		</table>
