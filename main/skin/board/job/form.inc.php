...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			<strong class="title"><label for="subject">공고명</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="category">지역선택</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f3">근무지역</label></strong> <span
				class="input"> <input type="text" name="f3" id="f3" class="w50p"
				value="<?=$dbData[0]['f3']?>" />
			</span>
		</div>

		<div class="box">
			<strong class="title"><label for="f1">직무내용</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f2">지원자격</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="f4">지원시기</label></strong> <span
				class="input"> <input type="text" name="f4" id="f4"
				class="date_input datepicker" value="<?=$dbData[0]['f4']?>" /> ~ <input
				type="text" name="f5" id="f5" class="date_input datepicker"
				value="<?=$dbData[0]['f5']?>" /> <span><input type="checkbox"
					name="num1" id="num1" value="1"
					<?=ischecked(1, $dbData[0]['num1'])?> /> <label for="num1">채용시 마감</label></span>
			</span>
		</div>
