...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			<strong class="title"><label for="date1">기간</label></strong> 
			<span class="input"> 
				<input type="text" name="date1" id="date1" class="date_input datepicker" value="<?=$dbData[0]['date1']?>" /> ~
				<input type="text" name="date2" id="date2" class="date_input datepicker" value="<?=$dbData[0]['date2']?>" />
			</span>
		</div>
