	...
	<div class="page_view">
		<div class="titlebox">
			...
			<div class="subjectinfo">
				<ul>
					<li><strong>직무내용</strong>
						<?=$dbData[0]['f1']?>
					</li>
					<li><strong>지원자격</strong>
						<?=$dbData[0]['f2']?>
					</li>
				</ul>
			</div>
			<div class="subjectinfo">
				<ul>
					<li><strong>지원시기</strong>
						<?=jobDateDisplay($dbData[0]['f4'], $dbData[0]['f5'], $dbData[0]['num1'])?>
					</li>
					<li><strong>근무지역</strong>
						<?=$dbData[0]['f3']?>
					</li>
				</ul>
			</div>
			<div class="datestat">
				<ul>
					...
					<li>
						<?=substr($writetime, 0, 16)?>
					</li>
					<li>조회
						<?=intval($dbData[0]['view'])?>
					</li>
				</ul>
			</div>
		</div>
