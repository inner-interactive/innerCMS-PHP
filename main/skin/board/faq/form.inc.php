...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			<strong class="title"><label for="subject">질문</label></strong> <span
		...
		<div class="box">
			<strong class="title"><label for="isimportant">공지사항</label></strong>
			<span class="input"><input type="checkbox" name="isimportant" id="isimportant" value="1" <?=ischecked($dbData[0]['isimportant'], '1')?> /></span>
		</div>
		<?php }?>
...
if ($userName == "") {
    ...
    if ($mode == "write" || $mode == "reply") {
		...
		<div class="box">
			<strong class="title"><label for="isimportant">답변</label></strong> <span
				class="input"><?php echo editor_html("memo", $dbData[0]['memo']);?></span>
		</div>
