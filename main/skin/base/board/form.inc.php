...
<div class="page_write">
	<fieldset>
		...
		<div class="box">
			...
			<span class="input"> 
				<input type="checkbox" name="isimportant" id="isimportant" value="1" <?=ischecked($dbData[0]['isimportant'], '1')?> /> 
		...
		<div class="box half_box">
			<strong class="title"><label for="upw">비밀번호</label></strong><span class="input">
			<input type="password" name="upw" id="upw" value="" style="ime-mode: disabled;" /></span>
		</div>
		<?php }else if($mode == "update"){?>
		<div class="box">
			<strong class="title"><label>이름</label></strong> 
			<span class="input"><input type="text" name="uname" id="uname" value="<?=$dbData[0]['uname']?>" readonly /></span>
		</div>
		<?php }?>
