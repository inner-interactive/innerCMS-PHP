var win_zip = function(frm_name, frm_zip, frm_addr1, frm_addr2, frm_addr3, frm_jibeon, zip_case) {
	...
	zip_case = typeof zip_case !== 'undefined' ? zip_case : 1 ;

//    var zip_case = 1;   
    //0이면 레이어, 1이면 페이지에 끼워 넣기, 2이면 새창
    ...
    switch(zip_case) {
        case 1 :    //iframe을 이용하여 페이지에 끼워 넣기
            ...
            if (element_wrap == null) {
                ...
                jQuery('form[name="'+frm_name+'"]').find('input[name="'+frm_zip+'"]').parent().prepend(element_wrap);
